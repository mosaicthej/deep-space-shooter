...
##    print('graphic background initalized!!')
    ...
    tempList00, tempList01 = copy.copy(bgPic_lst),[]
    tempN = len(bgPic_lst)
    tempK = random.randint(0,tempN)
    ...
    for i in range(tempN):
        if tempK < 0:
            ...
            #print(tempK)
            p00 = tempList00[tempK]
            tempList01.append(p00)
            #print(p00)

            tempK -= 1
    bgPic_lst = tempList01
        ...
        if wave%5 ==4:
            ...
            if cycle == wait+300:
                ...
                if  wave%3== 1 and wave > 1 and dmg_taken>0:
                    dmg_taken-=1
                if ply_power <12 and wave%5 == 4:
                    power_up_boo = True
                    power_up_val =random.choice([1,1,1,1,1,1,1,1,1,2,2,3,1])
