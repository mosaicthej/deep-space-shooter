...
def main():
    ...
    print('bgm loading...')
    bgm_lst_str = ['bgm001.ogg','bgm002.ogg','bgm003.ogg','Shanghai Alice of Meiji 17_1.ogg','Shanghai Alice of Meiji 17_2.ogg','Lunatic Princess!.ogg']
...
##        ply_power += random.choice([1,1,1,1,1,2,2,2,3,3])
    ...
    def create_enemy():
        ...
        if wave % 5 == 0:
            ...
            Boss_man = classes_vX3.Boss(0,(255,255,0),0,0,300,200,health_amount,1,0,length_health,50,10)
...
##        txt_time_survive = font.render ('time you survived: .2f'%time.clock(), True, (230,150,200))
