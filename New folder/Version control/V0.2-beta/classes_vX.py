    ...
    def shoot_enemy(self, cycle):
        ...
        if (self.cycle + self.random_cycle_increment) % self.cycle_length == 0:
            ...
            for i in range (self.number_bullets):
                ...
                bullet = Bullet(bullet_clr_rnd_00,(self.rect.x + (i+1)/(self.number_bullets+1)*self.width),(self.rect.y + self.height),0,bullet_speed_rnd_00)
    ...
    def shoot_enemy(self, cycle):
        ...
        if (self.cycle) % self.cycle_length == 0:
            ...
            for i in range (self.number_bullets):
                ...
                bullet_clr_rnd_00 = (255,255,0)
                #bullet_clr_rnd_00 = (255-30*bullet_speed_rnd_00,30*bullet_speed_rnd_00,30*bullet_speed_rnd_00)
                bullet = Bullet(bullet_clr_rnd_00,(self.rect.x + (i+1)/(self.number_bullets+1)*self.width),(self.rect.y + self.height),bullet_speed_rnd_00_x,bullet_speed_rnd_00_y)
                self.bullet_list.append(bullet)
